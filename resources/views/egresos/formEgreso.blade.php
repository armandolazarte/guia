...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            @if(isset($egreso))
                {!! Form::model($egreso, array('action' => array('EgresoController@update', $egreso->id), 'method' => 'patch', 'class' => 'form-horizontal')) !!}
            @else
                {!! Form::open(array('action' => 'EgresoController@store', 'class' => 'form-horizontal')) !!}
            @endif
            ...
            @include('partials.formErrors')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('cmt', null, array('class'=>'form-control')) !!}
                    </div>
                </div>
